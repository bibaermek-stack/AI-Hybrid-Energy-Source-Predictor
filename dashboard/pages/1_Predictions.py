...
from dashboard.views.predict import render

_FAVICON = Path(__file__).resolve().parent.parent / "static" / "favicon.png"
apply_page_config("EcoPredict | Predictions", _FAVICON)
...
st.markdown(
    icon_text("predict", (texts.get("title") or "EcoPredict AI") + " · Predictions", size=26, as_heading=True, level=1),
