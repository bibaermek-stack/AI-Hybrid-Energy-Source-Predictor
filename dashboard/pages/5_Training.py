...
from dashboard.views.training import render

_FAVICON = Path(__file__).resolve().parent.parent / "static" / "favicon.png"
apply_page_config("EcoPredict | Training", _FAVICON)
...
st.markdown(
    icon_text("training", (texts.get("title") or "EcoPredict AI") + " · Training", size=26, as_heading=True, level=1),
