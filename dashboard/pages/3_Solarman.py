...
from dashboard.utils import bootstrap  # noqa: F401 — path + 3D static assets
...
from dashboard.views.solarman import render

_FAVICON = Path(__file__).resolve().parent.parent / "static" / "favicon.png"
apply_page_config("EcoPredict | Solarman", _FAVICON)
...
page_title = (texts.get("title") or "EcoPredict AI") + " · Solarman"
st.markdown(
    icon_text("solarman", page_title, size=26, as_heading=True, level=1),
    unsafe_allow_html=True,
)
st.caption("Inverter2501221272 · Inverter2411046235 · live OpenAPI · 3D model")
