...
from dashboard.views.forecast import render

_FAVICON = Path(__file__).resolve().parent.parent / "static" / "favicon.png"
apply_page_config("EcoPredict | Forecast", _FAVICON)
...
st.markdown(
    icon_text("forecast", (texts.get("title") or "EcoPredict AI") + " · Forecast", size=26, as_heading=True, level=1),
