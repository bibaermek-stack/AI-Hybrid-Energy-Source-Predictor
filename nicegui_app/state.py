"""
Reactive Application State Container for EcoPredict AI NiceGUI App.
"""

from typing import Dict, Any, List, Callable
from nicegui_app.config import DEFAULT_API_BASE, get_text


class AppState:
    """State manager for NiceGUI application."""
