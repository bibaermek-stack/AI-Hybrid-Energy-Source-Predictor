...
**Қалғаны:**
- **Камера:** Flet 1.0 ядросында камера контролі жоқ; қосымша Flutter плагині (extension) керек — бөлек тапсырма. Қазір галерея.
- **Android «Артқа» батырмасы** әлі бүкіл қосымшадан шығады (Flet `page.views` маршрутына көшу керек).
